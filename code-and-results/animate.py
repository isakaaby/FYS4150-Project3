...
pos2 = np.array([x[:,2],y[:,2],z[:,2]]); pos3 = np.array([x[:,3],y[:,3],z[:,3]])
pos4 = np.array([x[:,4],y[:,4],z[:,4]]); pos5 = np.array([x[:,5],y[:,5],z[:,5]])
pos6 = np.array([x[:,6],y[:,6],z[:,6]]); pos7 = np.array([x[:,7],y[:,7],z[:,7]])
...
line, = ax.plot(pos[0,0:1],pos[1,0:1],pos[2,0:1])
line1, = ax.plot(pos1[0,0:1],pos1[1,0:1],pos1[2,0:1])
line2, = ax.plot(pos2[0,0:1],pos2[1,0:1],pos2[2,0:1])
line3, = ax.plot(pos3[0,0:1],pos3[1,0:1],pos3[2,0:1])
line4, = ax.plot(pos4[0,0:1],pos4[1,0:1],pos4[2,0:1])
line5, = ax.plot(pos5[0,0:1],pos5[1,0:1],pos5[2,0:1])
line6, = ax.plot(pos6[0,0:1],pos6[1,0:1],pos6[2,0:1])
line7, = ax.plot(pos7[0,0:1],pos7[1,0:1],pos7[2,0:1])
line8, = ax.plot(pos8[0,0:1],pos8[1,0:1],pos8[2,0:1])
line9, = ax.plot(pos9[0,0:1],pos9[1,0:1],pos9[2,0:1])
...
def animation_frame(num):
    ...
    return [line,line1,line2,line3,line4,line5,line6,line7,line8,line9]
